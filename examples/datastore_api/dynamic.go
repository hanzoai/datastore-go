...
func DynamicExample() error {
	...
	if err = batch.Append(datastore.NewDynamic("example dynamic")); err != nil {
		return err
	}

	if err = batch.Append(datastore.NewDynamicWithType("example dynamic with specific type", "String")); err != nil {
		return err
	}
