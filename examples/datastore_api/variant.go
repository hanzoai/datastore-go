...
func VariantExample() error {
	...
	if err = batch.Append(datastore.NewVariant("example variant")); err != nil {
		return err
	}

	if err = batch.Append(datastore.NewVariantWithType("example variant with specific type", "String")); err != nil {
		return err
	}
